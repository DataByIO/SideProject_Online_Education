...
public class CourseEnrollmentService {
    ...
    /** ✅ 리뷰 등록 시 승인된 수강생인지 확인 */
    public boolean isApprovedEnrolled(String userId, Long courseId) {
        return enrollmentRepo.isApprovedEnrolled(userId, courseId);
    }

    /** ✅ 승인된 강의 + 진도율 포함 전체 내역 조회 */
    public List<Map<String, Object>> getApprovedCoursesWithProgress(String userId) {
        return enrollmentRepo.findApprovedCoursesWithProgressByUserId(userId);
    }
}
